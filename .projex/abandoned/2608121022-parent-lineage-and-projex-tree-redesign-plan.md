...
- Existing `.projex/` documents use heterogeneous headers; some recent artifacts carry a Parent line, but none are governed because they predate the contract. No trusted-root registry or Parent-correction ledger exists.
