...
Write-Host "# cleanup: anything created here that git does not track (deps, build output, scratch) must be removed before close — untracked leftovers block worktree removal."
